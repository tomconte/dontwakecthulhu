...
compile:
	@zcc +sos -crt0=src/crt0.asm src/game.c src/lib.asm build/lib.o build/pill_*.c build/virus_*.c build/background_left.c build/background_right.c -o build/dontwake.bin
